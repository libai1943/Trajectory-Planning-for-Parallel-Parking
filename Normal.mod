...
s.t. COMPARISON_Atf02 :
AXij[NE,3] <= SL;

s.t. COMPARISON_Btf02 :
BXij[NE,3] <= SL;

s.t. COMPARISON_Ctf02 :
CXij[NE,3] <= SL;

s.t. COMPARISON_Dtf02 :
DXij[NE,3] <= SL;

s.t. COMPARISON_Atf05 :
AXij[NE,3] >= 0;

s.t. COMPARISON_Btf05 :
BXij[NE,3] >= 0;

s.t. COMPARISON_Ctf05 :
CXij[NE,3] >= 0;

s.t. COMPARISON_Dtf05 :
DXij[NE,3] >= 0;

################################# Bound constraints on control/state profiles
...
s.t. eq_PPoutsideABCD {ii in {1..2}, jj in {1..4}, i in I, j in K}:
...
s.t. eq_AoutsidePRECTANGLE {ii in {1..2}, i in I, j in K}:
...
s.t. eq_BoutsidePRECTANGLE {ii in {1..2}, i in I, j in K}:
...
s.t. eq_CoutsidePRECTANGLE {ii in {1..2}, i in I, j in K}:
...
s.t. eq_DoutsidePRECTANGLE {ii in {1..2}, i in I, j in K}:
